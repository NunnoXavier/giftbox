...
const NovaSenha = () => {
    ...
    return(
        <div className="bg-white border border-gray-200 rounded-lg p-2 place-center m-auto max-w-96 ">
            <h1 className="text-xl text-center font-bold text-gray-700 m-4">Nova Senha</h1>
            <div className={`grid grid-cols-12 gap-4 m-2 p-2 max-w-96 mx-auto`}>
                <div className="col-span-12 flex gap-2 items-center border border-gray-30 rounded-md px-2">
                    <input 
                    ...
                    <button className="abcursor-pointer text-gray-600" 
                ...
                <div className="col-span-12">
                    <button onClick={novaSenha} className="bg-violet-400 text-white rounded-md p-2 w-full">
                        Criar nova senha
