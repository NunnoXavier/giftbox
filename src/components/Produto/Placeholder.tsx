    ...
    return (
        <div className="animate-pulse">
            <div className="bg-white relative place-items-center border border-gray-200 rounded-lg h-96 md:h-[620px] mb-4">
                ...
                <div className="absolute w-82 h-56 bg-gray-200 top-6/12 left-1/2 -translate-1/2 rounded-lg">
                </div>
            </div>
            <div className="flex justify-center gap-2">
                <div className="bg-white relative md:h-20 h-[60px] border border-gray-200 rounded-lg w-20">
                    ...
                    <div className="absolute z-6 w-5 h-5 bg-gray-200 top-7/12 left-1/2 -translate-1/2 rounded-full"></div>
                    <div className="absolute w-15 h-8 bg-gray-200 top-7/12 left-1/2 -translate-1/2 rounded-xs"></div>
                </div>
                <div className="bg-white relative md:h-20 h-[60px] border border-gray-200 rounded-lg w-20">
                    <div className="absolute z-2 w-5 h-1 bg-gray-200 top-3/12 md:top-4/12  left-4/12 -translate-1/2 rounded-xs"></div>
                    <div className="absolute z-5 w-6 h-6 bg-white top-7/12 left-1/2 -translate-1/2 rounded-full"></div>
