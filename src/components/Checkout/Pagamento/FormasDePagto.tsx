    ...
    return (
        <div className="bg-white flex flex-col">
            <div className="flex gap-2">
                <button 
                    className={`${formaPagto === 'P'? 'bg-violet-200':'bg-white'} px-2 w-1/2 border border-gray-200 rounded-full`}
                    onClick={() => { 
                        setFormaPagto('P')
                ...
                <button 
                    className={`${formaPagto === 'C'? 'bg-violet-200':'bg-white'} px-2 w-1/2 border border-gray-200 rounded-full`}
                    onClick={() => {
                        setFormaPagto('C')
            ...
            <div className="">
                <div className={`${formaPagto === ''? 'h-full opacity-100':'h-0 opacity-0'} overflow-hidden p-2 transition-all ease-in-out duration-500`}>
                    <h1 className="font-semibold text-gray-500 mb-2">Escolha uma Forma de Pagamento</h1>
                </div>
                <div className={`${formaPagto === 'P'? 'h-full opacity-100':'h-0 opacity-0'} overflow-hidden p-2 text-gray-500 transition-all ease-in-out duration-500`}>
                ...
                <div className={`${formaPagto === 'C'? 'h-full opacity-100':'h-0 opacity-0'} overflow-hidden p-2 text-gray-500 transition-all ease-in-out duration-500`}>
